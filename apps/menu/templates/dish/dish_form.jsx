            ...
            <section className="MainsSection mt-8">
                <form onSubmit={handleSubmit} method="post" id="reservationForm">
                    <div className="form-group">
                        <label className="label-menu-form" htmlFor="table-number">Nom Plat</label>
                    ...
                    <div className="form-group">
                        <label className="label-menu-form" htmlFor="Capacity">Image</label>
                        <input onChange={handleChange} type="file" id="Capacity" name="Image" required />
                    </div>
              
                    <button type="submit" className="w-2/4 mt-8">Enregistrer</button>
                </form>
            </section>
